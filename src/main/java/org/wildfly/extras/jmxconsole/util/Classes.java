...
public final class Classes {
    ...
    public static void getAllInterfaces(List allIfaces, Class c) {
        ...
        while (c != null) {
            ...
            Collections.addAll(allIfaces, ifaces);
            c = c.getSuperclass();
        }
    }
    ...
    public static Class[] getAllUniqueInterfaces(Class c) {
        ...
        while (c != null) {
            Class[] ifaces = c.getInterfaces();
            Collections.addAll(uniqueIfaces, ifaces);
            c = c.getSuperclass();
        }
     ...
     */
    public static Class<?>[] convertToJavaClasses(Iterator<String> it,
                                                  ClassLoader cl)
            throws ClassNotFoundException {
     ...
     */
    public static Method getAttributeSetter(Class cls, String attr, Class type) throws NoSuchMethodException {
     ...
     *                                the specified ClassLoader
     */
    private static Class convertToJavaClass(String name,
                                            ClassLoader cl)
            throws ClassNotFoundException {
