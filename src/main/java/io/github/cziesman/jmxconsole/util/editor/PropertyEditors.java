...
public class PropertyEditors {
     ...
     * The Logger object
     */
    private static final Logger LOG = LoggerFactory.getLogger(PropertyEditors.class);
    ...
    /**
     * Whether initialization of the editor search path has been done
     */
